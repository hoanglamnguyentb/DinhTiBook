<template>
              ...
              <template v-if="column.key === 'action'">
                <ul class="list-inline hstack gap-2 mb-0">
                  ...
                  <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover"
                    ...
                    <!-- <b-link variant="text-primary" class="d-inline-block edit-item-btn" :href="`/dashboard/QL_ThongTinDanhMuc/`+record.maDM" >
  ...
  <ModalDetailDanhMuc ref="modalDetailDanhMuc"></ModalDetailDanhMuc>
  <modalAddEditDanhMuc @addSuccess="loadData(optionPage.pageIndex, optionPage.pageSize)" ref="modalAddEditDanhMuc">
  </modalAddEditDanhMuc>
...
import modalAddEditDanhMuc from "./ModalAddEditDanhMuc.vue";
import ModalDetailDanhMuc from "./ModalDetailDanhMuc.vue";
import ThongTinDanhMuc from "../QL_ThongTinDanhMuc/ThongTinDanhMuc.vue";
...
export default {
  ...
  data() {
    return {
      ...
      tableColumns: [
         { title: "TT", dataIndex: "thuTuHienThi", key: "ThuTuHienThi", sorter: (a, b) => a.thuTuHienThi - b.thuTuHienThi}, // Sắp xếp theo ID },
        { title: "Mã", dataIndex: "maDM", key: "MaDM" },
  ...
  methods: {
    ...
    // openListTTDM(maDM) {
    //     this.$router.push({ name: 'QL_ThongTinDanhMuc', params: { maDM: maDM } });
    // }
  }
};
</script>
