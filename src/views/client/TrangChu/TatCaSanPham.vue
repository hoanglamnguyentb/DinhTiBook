<template>
  <div style="background-color: white; padding-top: 70px">
    ...
    <div class="box-filter">
        <span class="btn-drop-filter btn-drop-filter4"><i class="fa fa-angle-down"></i></span>
        <a class="titlea"><span>Lọc theo</span> <br>Độ tuổi</a>
        <div class="outer outer-filter4">
                            <div class="div-input">
                    <input type="checkbox" onclick="checkAge(9)" name="age" id="age_9" value="9">
                    <label for="age_9">Từ 0-3</label>
                </div>
                            <div class="div-input">
                    <input type="checkbox" onclick="checkAge(1)" name="age" id="age_1" value="1">
                    <label for="age_1">Từ 3-6</label>
                </div>
                            <div class="div-input">
                    <input type="checkbox" onclick="checkAge(2)" name="age" id="age_2" value="2">
                    <label for="age_2">Từ 6-9</label>
                </div>
                            <div class="div-input">
                    <input type="checkbox" onclick="checkAge(3)" name="age" id="age_3" value="3">
                    <label for="age_3">Từ  9-12</label>
                </div>
                            <div class="div-input">
                    <input type="checkbox" onclick="checkAge(4)" name="age" id="age_4" value="4">
                    <label for="age_4">Từ 12-15</label>
                </div>
                            <div class="div-input">
                    <input type="checkbox" onclick="checkAge(5)" name="age" id="age_5" value="5">
                    <label for="age_5">Từ 15+</label>
                </div>
                            <div class="div-input">
                    <input type="checkbox" onclick="checkAge(10)" name="age" id="age_10" value="10">
                    <label for="age_10">0-6 tuổi</label>
                </div>
                    </div>
    </div>
    <div class="box-filter">
        <span class="btn-drop-filter btn-drop-filter5"><i class="fa fa-angle-down"></i></span>
        <a class="titlea"><span>Lọc theo</span> <br>Loại sách</a>
        <div class="outer outer-filter5">
                            <div class="div-input">
                    <input type="checkbox" onclick="checkType(1)" name="age" id="type_1" value="1">
                    <label for="type_1">Sách nổi bật</label>
                </div>
                            
                            <div class="div-input">
                    <input type="checkbox" onclick="checkType(3)" name="age" id="type_3" value="3">
    ...
    <div class="box-filter">
        ...
        <span class="btn-drop-filter btn-drop-filter6"><i class="fa fa-angle-down"></i></span>

        <div class="outer outer-filter6 box boxe ">
            <div class="div-input">
                <input type="checkbox" onclick="checkPrice(99)" name="price_prd" id="price_prd_99" value="99">
                <label for="price_prd_99">Tất cả</label>
            </div>
            <div class="div-input">
                <input type="checkbox" onclick="checkPrice(1)" name="price_prd" id="price_prd_1" value="1">
                <label for="price_prd_1">Dưới 50,000₫</label>
            </div>
            <div class="div-input">
                <input type="checkbox" onclick="checkPrice(2)" name="price_prd" id="price_prd_2" value="2">
                <label for="price_prd_2">Từ 50,000₫ - 99,000₫</label>

            </div>
            <div class="div-input">
                <input type="checkbox" onclick="checkPrice(3)" name="price_prd" id="price_prd_3" value="3">
                <label for="price_prd_3">Từ 100,000₫ - 199,000₫</label>
            </div>
            <div class="div-input">
                <input type="checkbox" onclick="checkPrice(4)" name="price_prd" id="price_prd_4" value="4">
                <label for="price_prd_4">Từ 200,000₫ - 299,000₫</label>
            </div>
            <div class="div-input">
                <input type="checkbox" onclick="checkPrice(5)" name="price_prd" id="price_prd_5" value="5">
    ...
    <div class="box-filter">
        ...
        <div class="outer outer-filter7 box boxe">
            <div class="div-input">
                <input type="checkbox" onclick="checkDiscount(1)" name="price_discount" id="price_discount_1" value="1">
                <label for="price_discount_1">Có</label>
            </div>
            <div class="div-input">
                <input type="checkbox" onclick="checkDiscount(0)" name="price_discount" id="price_discount_0" value="0" checked="">
    ...
    <div class="box-filter last-box">
        <span class="btn-drop-filter btn-drop-filter7"><i class="fa fa-angle-down"></i></span>
